...
class _MySQLProfilingQueryBuilder(ProfilingQueryBuilder):
    _MSG = "MySQL profiling query builder not implemented yet."
...
class MySQLConnector(DataSourceConnector):
    ...
    def test_connectivity(self, config: DataSourceConfig) -> ConnectivityTestResult:
        return ConnectivityTestResult(
            success=False,
            message="MySQL connector is not yet implemented.",
        )
    ...
    def open_connection(self, config: DataSourceConfig):
        raise NotImplementedError(
            "MySQL live connections are not implemented yet."
        )

    def get_query_builder(self) -> _MySQLProfilingQueryBuilder:
        return _MySQLProfilingQueryBuilder()
    ...
    def discover_schema(self, config: DataSourceConfig) -> SchemaSnapshot:
        return SchemaSnapshot(
            ...
            warnings=["Schema discovery is not yet implemented for MySQL."],
        )
